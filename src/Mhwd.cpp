...
bool Mhwd::readConfigFile(Config *config, std::string configPath)
{
	...
	for (std::vector<Config::HardwareIDs>::iterator iterator = config->hwdIDs_.begin();
			iterator != config->hwdIDs_.end(); iterator++)
	{
